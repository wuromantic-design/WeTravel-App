...
createApp({
    setup() {
        ...
        // 並開 forceAutoScrollFallback：touch 用模擬拖曳（非原生 HTML5 DnD），瀏覽器原生自動捲動不會生效，要靠這個 fallback 手動捲
        const scrollAutoOpts = () => ({ scroll: document.querySelector('main') || true, forceAutoScrollFallback: true, scrollSensitivity: 100, scrollSpeed: 15 });
